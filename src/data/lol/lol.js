export default {
  ...
  data: {
    ...
    Braum: {
      ...
      blurb:
        "''Would you like a bedtime story?''<br>''Grandma, I'm too old for that.''<br>''You're never too old to be told a story.''<br>The girl reluctantly crawls into bed and waits, knowing she won't win this battle. A bitter wind howls outside, ...",
      info: {
        attack: 3,
        defense: 9,
        magic: 4,
    ...
    Heimerdinger: {
      ...
      blurb:
        "From the Journal of Professor Cecil B. Heimerdinger<br>10.14<br>09:15<br>Current meteorological conditions in Bandle City seem optimal. Atmospheric pressure is ideal for today's experiments!<br>Running a fifth trial for my ...",
      info: {
        attack: 2,
        defense: 6,
        magic: 8,
